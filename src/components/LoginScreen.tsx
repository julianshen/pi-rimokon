  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ margin: '0 0 26px', color: 'var(--pi-text-muted)', fontSize: 14.5, lineHeight: 1.45 }}>
        ...
        {unconfigured ? (
          ...
          <>
            ...
            {error && (
              <p role="alert" style={{ margin: '12px 0 0', color: 'var(--pi-red)', fontSize: 13, fontWeight: 500, lineHeight: 1.45 }}>
                {error}
              </p>
            )}

            <p style={{ margin: '20px 0 0', color: 'var(--pi-text-fainter)', fontSize: 11.5, lineHeight: 1.5 }}>
  ...
  return (
    <div
      style={{
        ...
        border: '1px solid var(--pi-border-hair)',
        borderRadius: 12,
        padding: '14px 16px',
        fontSize: 13,
        lineHeight: 1.55,
    ...
    >
      <div style={{ fontWeight: 650, color: 'var(--pi-text)', marginBottom: 6 }}>Sign-in isn't configured yet</div>
      ...
      <div style={{ marginTop: 8, color: 'var(--pi-text-fainter)', fontSize: 12 }}>See the README for the full Supabase auth setup.</div>
    </div>
  )
}
